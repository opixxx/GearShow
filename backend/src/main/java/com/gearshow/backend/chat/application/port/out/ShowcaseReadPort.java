...
public interface ShowcaseReadPort {
    ...
    /**
     * 복수 쇼케이스 요약을 한 번에 조회한다.
     *
     * <p>구현은 showcase BC 의 배치 유스케이스 를 경유해 showcase · image 쿼리 각 1회만 발생시킨다.
     * 존재하지 않는 ID 는 결과 맵에서 생략된다.</p>
     *
     * @return showcaseId → summary 매핑 (존재하지 않는 ID 는 key 에서 생략)
     */
