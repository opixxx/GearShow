 ...
 *
 * <p>품질 옵션 ({@code texture_quality}, {@code face_limit}, {@code orientation}) 은 모두
 * nullable. {@link JsonInclude} 로 null 필드는 직렬화 시 제외되어, 옵션 미설정 시 Tripo
 * 측 default 가 적용된다 (테스트 / dev 환경 호환).</p>
 *
...
public record TripoTaskRequest(
    ...
    public record MultiviewOptions(
        ...
        public static MultiviewOptions defaults() {
            return new MultiviewOptions(null, null, null);
        }
    }
