...
public enum ErrorCode {
    ...
    // Redis Semaphore 슬롯 획득 실패 — 재시도 대상 (P1-E)
    TRIPO_SEMAPHORE_TIMEOUT(503, "Tripo 동시 요청 한도를 초과했습니다. 잠시 후 자동 재시도됩니다"),
    // Tripo task 가 failed/rejected 상태로 종결 — 폴링에서 감지 (P1-E)
    TRIPO_TASK_FAILED_POLL(500, "Tripo 모델 생성에 실패했습니다"),
